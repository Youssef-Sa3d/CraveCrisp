...
var h = (e2, t2) => {
  ...
  }, a4.open(o3.method, o3.url, true), a4.withCredentials = !!o3.withCredentials, h2 && a4.setRequestHeader)
    for (const e3 in h2)
      h2.hasOwnProperty(e3) && a4.setRequestHeader(e3, h2[e3]);
...
function l2() {
  ...
  return a3 = function(a4, c4) {
    ...
    if ("number" === p3 && isFinite(a4))
      return c4.long ? (u3 = a4, (l3 = Math.abs(u3)) >= n4 ? i2(u3, l3, n4, "day") : l3 >= s3 ? i2(u3, l3, s3, "hour") : l3 >= t2 ? i2(u3, l3, t2, "minute") : l3 >= e2 ? i2(u3, l3, e2, "second") : u3 + " ms") : function(r3) {
        var o4 = Math.abs(r3);
...
var p2 = function(e2) {
  ...
  return t2.debug = t2, t2.default = t2, t2.coerce = function(e3) {
    ...
    for (s4 = 0; s4 < r2; s4++)
      n5[s4] && ("-" === (e3 = n5[s4].replace(/\*/g, ".*?"))[0] ? t2.skips.push(new RegExp("^" + e3.slice(1) + "$")) : t2.names.push(new RegExp("^" + e3 + "$")));
  }, t2.enabled = function(e3) {
    if ("*" === e3[e3.length - 1])
      return true;
    let s4, n5;
    for (s4 = 0, n5 = t2.skips.length; s4 < n5; s4++)
      if (t2.skips[s4].test(e3))
        return false;
    for (s4 = 0, n5 = t2.names.length; s4 < n5; s4++)
      if (t2.names[s4].test(e3))
        return true;
    return false;
    ...
    for (let t3 = 0; t3 < e3.length; t3++)
      s4 = (s4 << 5) - s4 + e3.charCodeAt(t3), s4 |= 0;
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-JYTRXQBY.js").then(function(n4) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-A6X67FZN.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
   ...
   */
  events() {
    const apiVersion = __privateGet(this, _client7).config().apiVersion.replace(/^v/, "");
    if (apiVersion !== "X" && apiVersion < requiredApiVersion)
      throw new Error(
        `The live events API requires API version ${requiredApiVersion} or later. The current API version is ${apiVersion}. Please update your API version to use this feature.`
      );
    const path = _getDataUrl(__privateGet(this, _client7), "live/events"), url = new URL(__privateGet(this, _client7).getUrl(path, false)), listenFor = ["restart", "message"];
    return new Observable((observer) => {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" ? (await import("./browser-A6X67FZN.js")).default : EventSource;
        if (unsubscribed)
          return;
